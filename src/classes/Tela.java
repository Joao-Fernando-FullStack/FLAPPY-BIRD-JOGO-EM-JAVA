...
public class Tela extends JFrame
{
    ...
    public void textot(String texto, int x, int y, int tamanho, Cor cor) {
        g.setColor(new Color(cor.r, cor.g, cor.b));
        g.setFont(new Font("Comic Sans MS", Font.BOLD, tamanho));
    ...
    public void imagem(String arquivo, int xa, int ya, int larg, int alt, double dir, double x, double y) {
     ...
     public void imagem(){
        String arquivo="flappy.png";
        int xa=292, ya=442, larg=174, alt=44;
        double dir=0, x=100, y=100; 
